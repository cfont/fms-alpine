...
<div id="footer">
<p><?php print '<div class="footer-message">'. $footer_message .'</div>' . '<div class="footer">'. $footer .'</div>' . '<div class="credits"><a href="http://arborwebdevelopment.com" title="Drupal 6 Themes">Drupal 6 themes</a> by Arbor Web Development</div>'  ?></p>
</div>
<?php print $closure ?>
</body>
</html>
